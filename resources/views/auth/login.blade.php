...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>{{ config('app.name', 'SIGMA') }} - Login</title>
        ...
        <div class="min-h-screen flex items-center justify-center p-6">
            <div class="w-full max-w-sm space-y-8">
                <div class="text-center space-y-2">
                    ...
                    <p class="text-neutral-500 text-sm">Sistema de gestión</p>
                </div>
                ...
                >
                    ...
                    <div class="space-y-2">
                        ...
                        <input 
                            ...
                            required 
                            autofocus
                            class="w-full px-4 py-3 bg-white border border-neutral-300 rounded-lg text-base placeholder-neutral-400 focus:outline-none focus:border-neutral-900 focus:ring-1 focus:ring-neutral-900 transition-colors"
                        >
                    </div>
                    ...
                    <div class="flex items-center justify-between text-sm text-neutral-600">
                        <label class="flex items-center gap-2 cursor-pointer">
                            <input type="checkbox" name="remember" class="w-4 h-4 accent-neutral-900 bg-transparent border border-neutral-400 rounded">
                            <span>Recordarme</span>
                        </label>
                        
                        @if (Route::has('password.request'))
                            <a href="{{ route('password.request') }}" class="hover:text-neutral-900 transition-colors">
