{{-- Tab: Bitácora de tareas (fiel al legacy maintenance/tab.php) --}}
...
<div class="mb-5">
    ...
    <div class="flex items-center justify-end mb-3">
        <button class="px-3 py-1.5 rounded-lg text-xs font-bold uppercase tracking-widest flex items-center gap-1 transition-all hover:scale-[1.02] active:scale-[0.98]"
                ...
                hx-get="{{ route('maintenance.task.form', $id) }}"
...
(function(){
    function initTable(el) {
        ...
        window['mntTaskTable_{{ $id }}'] = new Tabulator(el, {
            pagination: true,
            ...
            sortMode: 'remote',
            layout: 'fitColumns',
            ajaxURL: '{{ route("maintenance.tasks", $id) }}',
            dataField: 'data',
