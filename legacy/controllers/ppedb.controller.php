...
class PPEDBController
{
    ...
    public function Data()
    {
        ...
        $total = $this->model->get('count(a.id) as total', 'epp_db a', $where)->total;
    ...
    {
        $user = $this->auth->authorize(120);
        require_once 'app/views/ppe/new.php';
    }
    ...
    public function Save()
    {
        ...
        if (! empty($_REQUEST['id'])) {
            $id = $this->model->update('epp_db', $item, $_REQUEST['id']);
        } else {
            $id = $this->model->save('epp_db', $item);
        }
    ...
    public function Detail()
    {
        ...
        if (! empty($_REQUEST['id'])) {
            ...
            $id = $this->model->get('*', 'epp_db', $filters);
        }
        require_once 'app/views/ppe/new.php';
    }
}
