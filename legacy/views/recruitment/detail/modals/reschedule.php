<div class="w-[95%] sm:w-[25%] bg-white p-4 rounded-lg shadow-lg relative z-50">
    ...
    <h1 class="text-black"><i class="ri-add-line text-2xl"></i> <span class="text-2xl font-semibold"> Reschedule Candidate <span></h1>
  ...
  >
    ...
    <input type="hidden" name="field" value="appointment">
