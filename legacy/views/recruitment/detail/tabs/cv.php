...
// Activado si $id->hired tiene cualquier valor (asumiendo que puede ser '1' o '0').
$is_hired = (isset($id->hired) && $id->hired !== '');

// Estilos base para el modo de solo lectura (texto plano)
$read_class = 'bg-gray-100 p-2 border border-gray-300 rounded text-gray-800 font-medium w-full';
$base_class = 'w-full border rounded px-3 py-2';
?>
...
<script>
htmx.on('cvChanged', function(e) {
    if (document.querySelector('#cinfo')) {
        htmx.trigger('#cinfo', 'refresh');
    }
});
</script>
