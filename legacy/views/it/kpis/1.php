<div class="grid grid-cols-1 lg:grid-cols-2 gap-4 items-start">
    ...
    <div class="overflow-auto bg-white p-4 shadow-lg rounded-xl"> 
        <h3 class="text-base font-semibold mb-3 text-gray-800"><i class="ri-table-line mr-2"></i>Reporte Mensual de Atención (IT)</h3>
        <table class="w-full text-xs text-left text-gray-700">
            <thead class="text-xxs uppercase bg-gray-50 border-b">
                <tr>
                    ...
                    <th class="px-2 py-2 text-center">Mora Entra</th>
                    <th class="px-2 py-2 text-center">Carga Total</th>
                    <th class="px-2 py-2 text-center text-orange-600 bg-orange-50">Atend. Mora</th>
                    <th class="px-2 py-2 text-center bg-blue-50">Total Atend.</th>
            ...
            <tbody>
                ...
                <tr class="border-b hover:bg-gray-50 transition text-center">
                    ...
                    <td class="px-2 py-1.5 text-orange-700 font-semibold bg-orange-50/50"><?= $r['at_mora']?></td>
                ...
                <tr class="bg-gray-100 font-bold border-b">
                    ...
                    <td class="text-center px-2 py-1.5 text-orange-800 bg-orange-200/50"><?= $sam_mora?></td>
...
<script>
// (El script de Chart.js se mantiene igual ya que usa las mismas variables result1 y dates)
