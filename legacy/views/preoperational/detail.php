...
// 1. Agrupamos los items por categoría para la vista
$items_by_category = [];
$all_items = $this->model->list(
    'a.*, q.question, q.category, q.items as q_items',
    'preoperational_items a',
    "AND preop_id = {$id->idd}",
    'LEFT JOIN preoperational_questions q ON a.question_id = q.id'
);
        ...
        <div class="flex items-center gap-3">
            ...
            <div>
                ...
                <p class="text-[10px] text-gray-400 uppercase font-bold tracking-widest">
                    Inspección de Equipo | <?= date('d/m/Y H:i', strtotime($id->created_at)) ?>
                </p>
            </div>
        </div>
