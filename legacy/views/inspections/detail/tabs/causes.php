<div class="mb-5">
    ...
    <div class="flex flex-col sm:flex-row justify-between items-center mb-3 gap-3">
        <input type="search" id="searchEvent" 
            ...
            placeholder="Search..."
            name="search"
            hx-post="?c=Infraimprovement&a=GetEvents&kind=cause&id=<?= $id->id ?>"
        ...
        <button 
            ...
            hx-get="?c=Infraimprovement&a=DetailModal&modal=add-cause&id=<?= $id->id ?>"
        ...
        <table class="w-full border-collapse rounded-md overflow-hidden border border-gray-200">
            <thead>
                <tr>
                    ...
                    <th class="bg-gray-100 px-3 py-2 text-left font-medium text-gray-700 text-xs">Evidence</th>
                    <th class="bg-gray-100 px-3 py-2 text-left font-medium text-gray-700 text-xs">Action</th>
                </tr>
            </thead>
            <tbody id="search-results" 
                class="overflow-auto max-h-[65vh]p-2"
                hx-get="?c=Infraimprovement&a=GetEvents&kind=cause&id=<?= $id->id ?>"
