    ...
    <div x-data="{ open: false }" class="relative">
        ...
        <div x-show="open" 
            ...
            <ul class="py-1 text-sm text-gray-700">
                ...
                <li>
                    <a href="#"
                        ...
                        onclick="event.preventDefault();
                            ...
                            htmx.ajax('GET', '?c=Locative&a=Update&id=<?= $id->id ?>&field=reason&reason=' + encodeURIComponent(reason));
                            }
                        "
                        class="block px-4 py-2 hover:bg-gray-100 flex items-center gap-2">
                ...
                <?php if ($canEdit and ! $id->ended_at) { ?>
                <li>
                    <a href="#"
                        hx-get="?c=Locative&a=Update"
                ...
                <li>
                    <a href="#"
                        ...
                        hx-get="?c=Locative&a=Modal&modal=rate&id=<?= $id->id ?>"
