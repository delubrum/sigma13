...
async function compressAndUpload(input) {
    ...
    try {
        ...
        const resp = await fetch('{{ route('preoperational.uploadPhoto') }}', { method: 'POST', headers: {'X-CSRF-TOKEN': '{{ csrf_token() }}'}, body: formData });
...
function handleFinalize() {
    ...
    htmx.ajax('POST', '{{ route('preoperational.finalize') }}', {
        target: '#silent_sync',
