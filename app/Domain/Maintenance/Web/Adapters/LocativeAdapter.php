...
use App\Domain\Maintenance\Data\MaintenanceTableData;
...
final class LocativeAdapter implements HasModule
{
    use AsAction;
    ...
    public function config(): Config
    {
        return new Config(
            ...
            subtitle:       'Mesa de servicio de infraestructura y edificios',
            icon:           'ri-building-line',
            newButtonLabel: 'Nuevo Ticket',
            modalWidth:     '85',
            columns:        SchemaGenerator::toColumns(MaintenanceTableData::class),
        );
    }
