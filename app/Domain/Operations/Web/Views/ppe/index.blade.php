    ...
    <div class="flex flex-col gap-6 h-full">
        ...
        <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
            <div class="flex items-center gap-1 bg-sigma-bg2 p-1 rounded-2xl w-fit border border-sigma-b shadow-inner">
                @foreach([
                    'db' => ['label' => 'Catalogue', 'icon' => 'ri-book-3-line'],
                    'stock' => ['label' => 'Stock', 'icon' => 'ri-inventory-line'],
                    'deliveries' => ['label' => 'Deliveries', 'icon' => 'ri-truck-line'],
                ] as $key => $item)
                    <a href="?tab={{ $key }}"
                       hx-get="?tab={{ $key }}"
                       hx-target="main"
            ...
            <div class="flex items-center gap-3">
                 {{-- Botón Nuevo --}}
                @if($tab === 'db')
                    <button hx-get="/operations/ppe/create" hx-target="#modal-body"
                ...
                @elseif($tab === 'stock')
                    <button hx-get="/operations/ppe/entry" hx-target="#modal-body"
                ...
                @elseif($tab === 'deliveries')
                    <button hx-get="/operations/ppe/delivery" hx-target="#modal-body"
