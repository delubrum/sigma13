...
final class Tasks
{
    ...
    public function asForm(Request $request, int $id): Response
    {
        $config = new Config(
            ...
            formFields: [
                ...
                new Field(name: 'notes',      label: 'Notas de trabajo', type: 'textarea', placeholder: 'Reporte técnico...', required: true),
            ],
        );
    ...
    public function asData(Request $request, int $id): JsonResponse
    {
        $rows = MntPItem::query()
            ...
            ->orderBy('mntp_items.created_at', 'asc')
            ->get();
