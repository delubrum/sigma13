...
final class Preventive implements \App\Contracts\HasModule
{
    use AsAction;
    ...
    public function handle(int $id): View
    {
        ...
        $automations = MntPreventiveForm::where('asset_id', $id)->get()->map(function (MntPreventiveForm $task): object {
        ...
        return view('assets.tabs.preventive', [
            'asset' => $asset,
